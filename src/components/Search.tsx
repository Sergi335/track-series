        ...
        <form className="flex w-full" onSubmit={handleSubmit}>
          ...
          <div className="relative w-full">
              ...
              <input
                ...
                className="block w-full p-4 ps-10 text-sm text-gray-900 border-2 border-gray-300 rounded-[12px] bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..."
